...
async function applyGroupPrivileges(group, groupsAPI, cid) {
...
async function applyUserPrivileges(user, groupsAPI, cid) {
	...
	method: async function () {
		...
		for (const cid of cids) {
			...
			for (const group of groups) {
				applyGroupPrivileges(group, groupsAPI, cid);
			}

			for (const user of users) {
				applyUserPrivileges(user, groupsAPI, cid);
			}
